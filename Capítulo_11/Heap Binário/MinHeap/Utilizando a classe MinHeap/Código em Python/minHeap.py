...
print('Heap após inserções:', heap.get_heap()) # Esperado: [1, 3, 8, 5]

# Extrair o menor elemento
min = heap.extract()
print('Elemento extraído:', min) # Esperado: 1

# Mostrar o estado do heap após a extração
print('Heap após extração:', heap.get_heap()) # Esperado: [3, 5, 8]

# Criar um array para heapify
print(heap.heapify())