...
tree.pre_order_traverse(print_node) # Imprime os valores na ordem pré-ordem
tree.post_order_traverse(print_node) # Imprime os valores na ordem pós-ordem

# Exemplos dos método de pesquisa
print(tree.min().key) # 3
print(tree.max().key) # 25
...
tree.in_order_traverse(print_node) # Imprime os valores em ordem crescente após a remoção
